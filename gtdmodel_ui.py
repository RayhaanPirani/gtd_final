...
def normalize(self, dbname):
    import sqlite3

    print_to_output(self.textBrowser, "Detected a database that is not normalized\nBeginning normalization process...")
    ...
    wconn.commit()
    print_to_output(self.textBrowser, "Created and populated basic tables.")
    ...
    wconn.commit()
    print_to_output(self.textBrowser, "Created and populated the main table structure.")
    ...
    wconn.commit()
    print_to_output(self.textBrowser, "Created and populated detail tables.")


    print_to_output(self.textBrowser, "Modelled database '" + outdbname + "' created successfully.")
    wconn.close()
    rconn.close()
    return outdbname